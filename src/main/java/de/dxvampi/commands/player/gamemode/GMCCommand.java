...
public class GMCCommand implements CommandExecutor, TabCompleter {
    ...
    public GMCCommand(DeEssentials plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NonNull CommandSender sender, @NonNull Command command, @NonNull String label, String @NonNull [] args) {
        ...
        if (!sender.hasPermission("deessentials.gamemode.*")) {
            if (!sender.hasPermission("deessentials.gamemode.creative")) {
        ...
        to_change.sendMessage(MessageUtils.getColoredMessage("&aYour gamemode has been set to &e" + "creative"));
        if (to_change != sender) {
            sender.sendMessage(MessageUtils.getColoredMessage("&aYou have changed &f" + to_change.getName() + "&a's gamemode to &e" + "creative"));
        }
        return true;
    }
