...
public class GMACommand implements CommandExecutor, TabCompleter {
    ...
    public GMACommand(DeEssentials plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NonNull CommandSender sender, @NonNull Command command, @NonNull String label, String @NonNull [] args) {
        ...
        if (!sender.hasPermission("deessentials.gamemode.*")) {
            if (!sender.hasPermission("deessentials.gamemode.adventure")) {
        ...
        to_change.setGameMode(GameMode.ADVENTURE);
        to_change.sendMessage(MessageUtils.getColoredMessage("&aYour gamemode has been set to &e" + "adventure"));
        if (to_change != sender) {
            sender.sendMessage(MessageUtils.getColoredMessage("&aYou have changed &f" + to_change.getName() + "&a's gamemode to &e" + "adventure"));
        }
        return true;
    }
